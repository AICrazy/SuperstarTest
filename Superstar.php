...
<div class="verybottom">
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="aligncenter">
          <p>Copyright &copy; <a target="_blank" href="http://AICrazy.top/">疯狂的AI</a></p>
 	  <p><a target="_blank" href="http://www.miitbeian.gov.cn/" style="opacity: 1;z-index: 10; background:url(about:blank);color:#6F6E6E">蜀ICP备18014896号-1</a></p>
        </div>
      </div>
    </div>
  </div>
